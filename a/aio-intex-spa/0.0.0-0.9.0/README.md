# Comparing `tmp/aio_intex_spa-0.0.0.tar.gz` & `tmp/aio-intex-spa-0.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "aio_intex_spa-0.0.0.tar", last modified: Thu Apr 25 14:04:32 2024, max compression
+gzip compressed data, was "aio-intex-spa-0.9.0.tar", last modified: Mon Mar 11 20:41:04 2024, max compression
```

## Comparing `aio_intex_spa-0.0.0.tar` & `aio-intex-spa-0.9.0.tar`

### file list

```diff
@@ -1,23 +1,22 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 14:04:32.094451 aio_intex_spa-0.0.0/
--rw-r--r--   0 runner    (1001) docker     (127)     1083 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     2614 2024-04-25 14:04:32.094451 aio_intex_spa-0.0.0/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     2179 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 14:04:32.090451 aio_intex_spa-0.0.0/aio_intex_spa/
--rw-r--r--   0 runner    (1001) docker     (127)      201 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     9077 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/intex_spa.py
--rw-r--r--   0 runner    (1001) docker     (127)      240 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_exceptions.py
--rw-r--r--   0 runner    (1001) docker     (127)     3728 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_network_layer.py
--rw-r--r--   0 runner    (1001) docker     (127)     1741 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_object_info.py
--rw-r--r--   0 runner    (1001) docker     (127)     4518 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_object_status.py
--rw-r--r--   0 runner    (1001) docker     (127)     4491 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_query.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 14:04:32.094451 aio_intex_spa-0.0.0/aio_intex_spa.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     2614 2024-04-25 14:04:32.000000 aio_intex_spa-0.0.0/aio_intex_spa.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      517 2024-04-25 14:04:32.000000 aio_intex_spa-0.0.0/aio_intex_spa.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-25 14:04:32.000000 aio_intex_spa-0.0.0/aio_intex_spa.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       20 2024-04-25 14:04:32.000000 aio_intex_spa-0.0.0/aio_intex_spa.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)      165 2024-04-25 14:04:32.094451 aio_intex_spa-0.0.0/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      676 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-25 14:04:32.094451 aio_intex_spa-0.0.0/tests/
--rw-r--r--   0 runner    (1001) docker     (127)       18 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     1603 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/tests/test_intex_spa_query_checksum.py
--rw-r--r--   0 runner    (1001) docker     (127)     1457 2024-04-25 14:04:27.000000 aio_intex_spa-0.0.0/tests/test_intex_spa_status.py
...
### Comparing `aio_intex_spa-0.0.0/LICENSE` & `aio-intex-spa-0.9.0/LICENSE`

 * *Files identical despite different names*

### Comparing `aio_intex_spa-0.0.0/PKG-INFO` & `aio-intex-spa-0.9.0/PKG-INFO`
...
### Comparing `aio_intex_spa-0.0.0/README.md` & `aio-intex-spa-0.9.0/README.md`
...
### Comparing `aio_intex_spa-0.0.0/aio_intex_spa/intex_spa.py` & `aio-intex-spa-0.9.0/aio_intex_spa/intex_spa.py`
...
### Comparing `aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_network_layer.py` & `aio-intex-spa-0.9.0/aio_intex_spa/intex_spa_network_layer.py`
...
### Comparing `aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_object_info.py` & `aio-intex-spa-0.9.0/aio_intex_spa/intex_spa_object_info.py`
...
### Comparing `aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_object_status.py` & `aio-intex-spa-0.9.0/aio_intex_spa/intex_spa_object_status.py`
...
### Comparing `aio_intex_spa-0.0.0/aio_intex_spa/intex_spa_query.py` & `aio-intex-spa-0.9.0/aio_intex_spa/intex_spa_query.py`
...
### Comparing `aio_intex_spa-0.0.0/aio_intex_spa.egg-info/PKG-INFO` & `aio-intex-spa-0.9.0/aio_intex_spa.egg-info/PKG-INFO`
...
### Comparing `aio_intex_spa-0.0.0/setup.py` & `aio-intex-spa-0.9.0/setup.py`
...
### Comparing `aio_intex_spa-0.0.0/tests/test_intex_spa_query_checksum.py` & `aio-intex-spa-0.9.0/tests/test_intex_spa_query_checksum.py`
...
### Comparing `aio_intex_spa-0.0.0/tests/test_intex_spa_status.py` & `aio-intex-spa-0.9.0/tests/test_intex_spa_status.py`
