# Comparing `tmp/musicntwrk-2.3.2.tar.gz` & `tmp/musicntwrk-2.3.3.tar.gz`
...
### Comparing `musicntwrk-2.3.2/README.md` & `musicntwrk-2.3.3/README.md`
...
### Comparing `musicntwrk-2.3.2/src/networks/scoreDictionary.py` & `musicntwrk-2.3.3/src/networks/scoreDictionary.py`
...
### Comparing `musicntwrk-2.3.2/src/networks/vLeadNetworkByName.py` & `musicntwrk-2.3.3/src/networks/vLeadNetworkByName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/networks/vLeadNetworkByNameVec.py` & `musicntwrk-2.3.3/src/networks/vLeadNetworkByNameVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/networks/vLeadNetworkVec.py` & `musicntwrk-2.3.3/src/networks/vLeadNetworkVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/barplot.py` & `musicntwrk-2.3.3/src/plotting/barplot.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/chordspace.py` & `musicntwrk-2.3.3/src/plotting/chordspace.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/drawMultiLayerNetwork.py` & `musicntwrk-2.3.3/src/plotting/drawMultiLayerNetwork.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/drawNetwork.py` & `musicntwrk-2.3.3/src/plotting/drawNetwork.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/drawNetwork3D.py` & `musicntwrk-2.3.3/src/plotting/drawNetwork3D.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/drawNetworkViz.py` & `musicntwrk-2.3.3/src/plotting/drawNetworkViz.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/drawNetworkX.py` & `musicntwrk-2.3.3/src/plotting/drawNetworkX.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/plotCC.py` & `musicntwrk-2.3.3/src/plotting/plotCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/plotCurveXY.py` & `musicntwrk-2.3.3/src/plotting/plotCurveXY.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/plotCurveY.py` & `musicntwrk-2.3.3/src/plotting/plotCurveY.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/plotDegreeAnalysis.py` & `musicntwrk-2.3.3/src/plotting/plotDegreeAnalysis.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/plotting/plotOpsHistogram.py` & `musicntwrk-2.3.3/src/plotting/plotOpsHistogram.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeASCBW.py` & `musicntwrk-2.3.3/src/timbre/computeASCBW.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeCompMPS.py` & `musicntwrk-2.3.3/src/timbre/computeCompMPS.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeMFCC.py` & `musicntwrk-2.3.3/src/timbre/computeMFCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeModifiedASCBW.py` & `musicntwrk-2.3.3/src/timbre/computeModifiedASCBW.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computePSCC.py` & `musicntwrk-2.3.3/src/timbre/computePSCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeStandardizedMFCC.py` & `musicntwrk-2.3.3/src/timbre/computeStandardizedMFCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeStandardizedMFPS.py` & `musicntwrk-2.3.3/src/timbre/computeStandardizedMFPS.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/computeStandardizedPSCC.py` & `musicntwrk-2.3.3/src/timbre/computeStandardizedPSCC.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/mfccSoundDecay.py` & `musicntwrk-2.3.3/src/timbre/mfccSoundDecay.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/mfccSoundDecayOptimal.py` & `musicntwrk-2.3.3/src/timbre/mfccSoundDecayOptimal.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/mfccSoundDecayPiecewise.py` & `musicntwrk-2.3.3/src/timbre/mfccSoundDecayPiecewise.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/minimizeBKPT.py` & `musicntwrk-2.3.3/src/timbre/minimizeBKPT.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/normSoundDecay.py` & `musicntwrk-2.3.3/src/timbre/normSoundDecay.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/timbre/normSoundDecay2.py` & `musicntwrk-2.3.3/src/timbre/normSoundDecay2.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/Remove.py` & `musicntwrk-2.3.3/src/utils/Remove.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/SegmentedLinearReg.py` & `musicntwrk-2.3.3/src/utils/SegmentedLinearReg.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/Sublists.py` & `musicntwrk-2.3.3/src/utils/Sublists.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/communications.py` & `musicntwrk-2.3.3/src/utils/communications.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/diffusionEntropyAnalyis.py` & `musicntwrk-2.3.3/src/utils/diffusionEntropyAnalyis.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/diffusionEntropyAnalyisNew.py` & `musicntwrk-2.3.3/src/utils/diffusionEntropyAnalyisNew.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/entropyKLdiv.py` & `musicntwrk-2.3.3/src/utils/entropyKLdiv.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/extractByString.py` & `musicntwrk-2.3.3/src/utils/extractByString.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/fetchWaves.py` & `musicntwrk-2.3.3/src/utils/fetchWaves.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/findLengthMax.py` & `musicntwrk-2.3.3/src/utils/findLengthMax.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/flatten.py` & `musicntwrk-2.3.3/src/utils/flatten.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/floatize.py` & `musicntwrk-2.3.3/src/utils/floatize.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/generalizedOpsHistogram.py` & `musicntwrk-2.3.3/src/utils/generalizedOpsHistogram.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/generalizedOpsName.py` & `musicntwrk-2.3.3/src/utils/generalizedOpsName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/init_list_of_objects.py` & `musicntwrk-2.3.3/src/utils/init_list_of_objects.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/load_balancing.py` & `musicntwrk-2.3.3/src/utils/load_balancing.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/minimalDistance.py` & `musicntwrk-2.3.3/src/utils/minimalDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/minimalDistanceVec.py` & `musicntwrk-2.3.3/src/utils/minimalDistanceVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/minimalNoBijDistance.py` & `musicntwrk-2.3.3/src/utils/minimalNoBijDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsCheckByName.py` & `musicntwrk-2.3.3/src/utils/opsCheckByName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsCheckByNameVec.py` & `musicntwrk-2.3.3/src/utils/opsCheckByNameVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsDistance.py` & `musicntwrk-2.3.3/src/utils/opsDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsHistogram.py` & `musicntwrk-2.3.3/src/utils/opsHistogram.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsName.py` & `musicntwrk-2.3.3/src/utils/opsName.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsNameFull.py` & `musicntwrk-2.3.3/src/utils/opsNameFull.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/opsNameVec.py` & `musicntwrk-2.3.3/src/utils/opsNameVec.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/play_with_simpleaudio.py` & `musicntwrk-2.3.3/src/utils/play_with_simpleaudio.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/powerFit.py` & `musicntwrk-2.3.3/src/utils/powerFit.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/rhythmDistance.py` & `musicntwrk-2.3.3/src/utils/rhythmDistance.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/scaleFreeFit.py` & `musicntwrk-2.3.3/src/utils/scaleFreeFit.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/score2vLead.py` & `musicntwrk-2.3.3/src/utils/score2vLead.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/str2float.py` & `musicntwrk-2.3.3/src/utils/str2float.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/str2frac.py` & `musicntwrk-2.3.3/src/utils/str2frac.py`

 * *Files identical despite different names*

### Comparing `musicntwrk-2.3.2/src/utils/vectorDistance.py` & `musicntwrk-2.3.3/src/utils/vectorDistance.py`
