# Comparing `tmp/mpc_obscodes-2024.4.24.tar.gz` & `tmp/mpc_obscodes-2024.4.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mpc_obscodes-2024.4.24.tar", last modified: Wed Apr 24 02:23:18 2024, max compression
+gzip compressed data, was "mpc_obscodes-2024.4.5.tar", last modified: Fri Apr  5 02:22:26 2024, max compression
```

## Comparing `mpc_obscodes-2024.4.24.tar` & `mpc_obscodes-2024.4.5.tar`

### file list

```diff
@@ -1,23 +1,23 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 02:23:18.051733 mpc_obscodes-2024.4.24/
--rw-r--r--   0 runner    (1001) docker     (127)       86 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (127)     2445 2024-04-24 02:23:18.051733 mpc_obscodes-2024.4.24/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     2148 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 02:23:18.047733 mpc_obscodes-2024.4.24/mpc_obscodes/
--rw-r--r--   0 runner    (1001) docker     (127)      187 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     1329 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/compare.py
--rw-r--r--   0 runner    (1001) docker     (127)     3446 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/fetch.py
--rw-r--r--   0 runner    (1001) docker     (127)   253885 2024-04-24 02:23:12.000000 mpc_obscodes-2024.4.24/mpc_obscodes/obscodes_extended.json
--rw-r--r--   0 runner    (1001) docker     (127)       56 2024-04-24 02:23:12.000000 mpc_obscodes-2024.4.24/mpc_obscodes/obscodes_extended.md5
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 02:23:18.051733 mpc_obscodes-2024.4.24/mpc_obscodes/tests/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     1164 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/tests/test_compare.py
--rw-r--r--   0 runner    (1001) docker     (127)      649 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/tests/test_fetch.py
--rw-r--r--   0 runner    (1001) docker     (127)      653 2024-04-24 02:23:09.000000 mpc_obscodes-2024.4.24/mpc_obscodes/tests/test_mpc_obscodes.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 02:23:18.051733 mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     2445 2024-04-24 02:23:18.000000 mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      496 2024-04-24 02:23:18.000000 mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-24 02:23:18.000000 mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-04-24 02:23:18.000000 mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       13 2024-04-24 02:23:18.000000 mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)      571 2024-04-24 02:23:12.000000 mpc_obscodes-2024.4.24/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-24 02:23:18.051733 mpc_obscodes-2024.4.24/setup.cfg
...
### Comparing `mpc_obscodes-2024.4.24/PKG-INFO` & `mpc_obscodes-2024.4.5/PKG-INFO`
...
### Comparing `mpc_obscodes-2024.4.24/README.md` & `mpc_obscodes-2024.4.5/README.md`

 * *Files identical despite different names*

### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes/compare.py` & `mpc_obscodes-2024.4.5/mpc_obscodes/compare.py`

 * *Files identical despite different names*

### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes/fetch.py` & `mpc_obscodes-2024.4.5/mpc_obscodes/fetch.py`

 * *Files identical despite different names*

### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes/obscodes_extended.json` & `mpc_obscodes-2024.4.5/mpc_obscodes/obscodes_extended.json`

 * *Files 0% similar despite different names*

#### Pretty-printed

 * *Similarity: 0.9973854581673307%*
...
### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes/tests/test_compare.py` & `mpc_obscodes-2024.4.5/mpc_obscodes/tests/test_compare.py`

 * *Files identical despite different names*

### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes/tests/test_fetch.py` & `mpc_obscodes-2024.4.5/mpc_obscodes/tests/test_fetch.py`

 * *Files identical despite different names*

### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes/tests/test_mpc_obscodes.py` & `mpc_obscodes-2024.4.5/mpc_obscodes/tests/test_mpc_obscodes.py`

 * *Files identical despite different names*

### Comparing `mpc_obscodes-2024.4.24/mpc_obscodes.egg-info/PKG-INFO` & `mpc_obscodes-2024.4.5/mpc_obscodes.egg-info/PKG-INFO`
...
### Comparing `mpc_obscodes-2024.4.24/pyproject.toml` & `mpc_obscodes-2024.4.5/pyproject.toml`
