# Comparing `tmp/multidefusion-0.0.17.tar.gz` & `tmp/multidefusion-0.0.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "multidefusion-0.0.17.tar", last modified: Thu Apr 25 13:20:37 2024, max compression
+gzip compressed data, was "multidefusion-0.0.6.tar", last modified: Wed Apr 10 15:01:04 2024, max compression
```

## Comparing `multidefusion-0.0.17.tar` & `multidefusion-0.0.6.tar`

### file list

```diff
@@ -1,24 +1,26 @@
-drwxrwxrwx   0        0        0        0 2024-04-25 13:20:37.847771 multidefusion-0.0.17/
--rw-rw-rw-   0        0        0      154 2024-04-21 08:50:10.000000 multidefusion-0.0.17/AUTHORS.rst
--rw-rw-rw-   0        0        0     1094 2024-04-10 14:26:29.000000 multidefusion-0.0.17/LICENSE
--rw-rw-rw-   0        0        0      129 2024-04-10 14:26:29.000000 multidefusion-0.0.17/MANIFEST.in
--rw-rw-rw-   0        0        0     2810 2024-04-25 13:20:37.847771 multidefusion-0.0.17/PKG-INFO
--rw-rw-rw-   0        0        0     1823 2024-04-24 19:38:47.000000 multidefusion-0.0.17/README.md
-drwxrwxrwx   0        0        0        0 2024-04-25 13:20:37.847771 multidefusion-0.0.17/multidefusion/
--rw-rw-rw-   0        0        0      142 2024-04-10 14:26:29.000000 multidefusion-0.0.17/multidefusion/__init__.py
--rw-rw-rw-   0        0        0    19080 2024-04-20 15:07:40.000000 multidefusion-0.0.17/multidefusion/datainterface.py
--rw-rw-rw-   0        0        0     2898 2024-04-24 18:40:07.000000 multidefusion-0.0.17/multidefusion/fusion.py
--rw-rw-rw-   0        0        0    26310 2024-04-22 12:20:09.000000 multidefusion-0.0.17/multidefusion/integration.py
--rw-rw-rw-   0        0        0    52030 2024-04-24 18:42:36.000000 multidefusion-0.0.17/multidefusion/results.py
-drwxrwxrwx   0        0        0        0 2024-04-25 13:20:37.847771 multidefusion-0.0.17/multidefusion.egg-info/
--rw-rw-rw-   0        0        0     2810 2024-04-25 13:20:37.000000 multidefusion-0.0.17/multidefusion.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      460 2024-04-25 13:20:37.000000 multidefusion-0.0.17/multidefusion.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0       70 2024-04-25 13:20:37.000000 multidefusion-0.0.17/multidefusion.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        2 2024-04-10 14:55:46.000000 multidefusion-0.0.17/multidefusion.egg-info/not-zip-safe
--rw-rw-rw-   0        0        0       70 2024-04-25 13:20:37.000000 multidefusion-0.0.17/multidefusion.egg-info/requires.txt
--rw-rw-rw-   0        0        0       14 2024-04-25 13:20:37.000000 multidefusion-0.0.17/multidefusion.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       73 2024-04-10 14:50:44.000000 multidefusion-0.0.17/requirements.txt
--rw-rw-rw-   0        0        0      421 2024-04-25 13:20:37.847771 multidefusion-0.0.17/setup.cfg
--rw-rw-rw-   0        0        0     1831 2024-04-25 13:16:29.000000 multidefusion-0.0.17/setup.py
-drwxrwxrwx   0        0        0        0 2024-04-25 13:20:37.847771 multidefusion-0.0.17/tests/
--rw-rw-rw-   0        0        0      435 2024-04-22 12:43:47.000000 multidefusion-0.0.17/tests/test_multidefusion.py
...
### Comparing `multidefusion-0.0.17/LICENSE` & `multidefusion-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `multidefusion-0.0.17/multidefusion/datainterface.py` & `multidefusion-0.0.6/multidefusion/datainterface.py`
...
### Comparing `multidefusion-0.0.17/multidefusion/integration.py` & `multidefusion-0.0.6/multidefusion/integration.py`
...
### Comparing `multidefusion-0.0.17/multidefusion/results.py` & `multidefusion-0.0.6/multidefusion/results.py`
...
### Comparing `multidefusion-0.0.17/setup.py` & `multidefusion-0.0.6/setup.py`
