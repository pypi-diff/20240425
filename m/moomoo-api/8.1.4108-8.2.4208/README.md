# Comparing `tmp/moomoo-api-8.1.4108.tar.gz` & `tmp/moomoo-api-8.2.4208.tar.gz`
...
### Comparing `moomoo-api-8.1.4108/LICENSE` & `moomoo-api-8.2.4208/LICENSE`
...
### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/GetDelayStatistics_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/GetDelayStatistics_pb2.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetAccList_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetAccList_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetFunds_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetFunds_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetHistoryOrderFillList_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetHistoryOrderFillList_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetHistoryOrderList_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetHistoryOrderList_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetMarginRatio_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetMarginRatio_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetMaxTrdQtys_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetMaxTrdQtys_pb2.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetOrderFillList_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetOrderFillList_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetOrderList_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetOrderList_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_GetPositionList_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_GetPositionList_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_ModifyOrder_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_ModifyOrder_pb2.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_Notify_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_Notify_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_PlaceOrder_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_PlaceOrder_pb2.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_ReconfirmOrder_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_ReconfirmOrder_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_SubAccPush_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_SubAccPush_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_UnlockTrade_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_UnlockTrade_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_UpdateOrderFill_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_UpdateOrderFill_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Trd_UpdateOrder_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Trd_UpdateOrder_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/UsedQuota_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/UsedQuota_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pb/Verification_pb2.py` & `moomoo-api-8.2.4208/moomoo/common/pb/Verification_pb2.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/pbjson.py` & `moomoo-api-8.2.4208/moomoo/common/pbjson.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/sys_config.py` & `moomoo-api-8.2.4208/moomoo/common/sys_config.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/common/utils.py` & `moomoo-api-8.2.4208/moomoo/common/utils.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/examples/get_mkt_snapshot_demo.py` & `moomoo-api-8.2.4208/moomoo/examples/get_mkt_snapshot_demo.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/examples/macd_strategy.py` & `moomoo-api-8.2.4208/moomoo/examples/macd_strategy.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/examples/quote_and_trade_demo.py` & `moomoo-api-8.2.4208/moomoo/examples/quote_and_trade_demo.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/examples/quote_push.py` & `moomoo-api-8.2.4208/moomoo/examples/quote_push.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/examples/simple_filter_demo.py` & `moomoo-api-8.2.4208/moomoo/examples/simple_filter_demo.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/examples/stocksell_demo.py` & `moomoo-api-8.2.4208/moomoo/examples/stocksell_demo.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/quote/open_quote_context.py` & `moomoo-api-8.2.4208/moomoo/quote/open_quote_context.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/quote/quote_get_warrant.py` & `moomoo-api-8.2.4208/moomoo/quote/quote_get_warrant.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/quote/quote_query.py` & `moomoo-api-8.2.4208/moomoo/quote/quote_query.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/quote/quote_response_handler.py` & `moomoo-api-8.2.4208/moomoo/quote/quote_response_handler.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/quote/quote_stockfilter_info.py` & `moomoo-api-8.2.4208/moomoo/quote/quote_stockfilter_info.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/quote/quote_tool.py` & `moomoo-api-8.2.4208/moomoo/quote/quote_tool.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/tools/Common.proto.json` & `moomoo-api-8.2.4208/moomoo/tools/Common.proto.json`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/tools/generate_code.py` & `moomoo-api-8.2.4208/moomoo/tools/generate_code.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/tools/load_template.py` & `moomoo-api-8.2.4208/moomoo/tools/load_template.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo/trade/open_trade_context.py` & `moomoo-api-8.2.4208/moomoo/trade/open_trade_context.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/trade/trade_query.py` & `moomoo-api-8.2.4208/moomoo/trade/trade_query.py`
...
### Comparing `moomoo-api-8.1.4108/moomoo/trade/trade_response_handler.py` & `moomoo-api-8.2.4208/moomoo/trade/trade_response_handler.py`

 * *Files identical despite different names*

### Comparing `moomoo-api-8.1.4108/moomoo_api.egg-info/PKG-INFO` & `moomoo-api-8.2.4208/moomoo_api.egg-info/PKG-INFO`
...
### Comparing `moomoo-api-8.1.4108/moomoo_api.egg-info/SOURCES.txt` & `moomoo-api-8.2.4208/moomoo_api.egg-info/SOURCES.txt`
...
+moomoo/common/pb/Trd_GetOrderFee_pb2.py
...
### Comparing `moomoo-api-8.1.4108/setup.py` & `moomoo-api-8.2.4208/setup.py`
