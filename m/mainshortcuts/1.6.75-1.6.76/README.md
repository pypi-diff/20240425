# Comparing `tmp/mainshortcuts-1.6.75.tar.gz` & `tmp/mainshortcuts-1.6.76.tar.gz`
...
### Comparing `mainshortcuts-1.6.75/src/MainShortcuts/file.py` & `mainshortcuts-1.6.76/src/MainShortcuts/file.py`
