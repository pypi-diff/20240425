# Comparing `tmp/refract-serving-0.0.8.tar.gz` & `tmp/refract-serving-1.0.1a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/refract-serving-0.0.8.tar", last modified: Thu Apr 25 05:59:32 2024, max compression
+gzip compressed data, was "dist/refract-serving-1.0.1a0.tar", last modified: Fri Jan 12 09:37:44 2024, max compression
```

## Comparing `refract-serving-0.0.8.tar` & `refract-serving-1.0.1a0.tar`

### file list

```diff
@@ -1,34 +1,36 @@
-drwxr-xr-x   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:59:32.969279 refract-serving-0.0.8/
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)       38 2024-04-24 04:23:40.000000 refract-serving-0.0.8/MANIFEST.in
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)      264 2024-04-25 05:59:32.969279 refract-serving-0.0.8/PKG-INFO
-drwxr-xr-x   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:59:32.965278 refract-serving-0.0.8/refract_serving/
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     6232 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/README.md
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:17:10.000000 refract-serving-0.0.8/refract_serving/__init__.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)    17661 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/app.py
-drwxr-xr-x   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:59:32.969279 refract-serving-0.0.8/refract_serving/batch_serving/
-drwxr-xr-x   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:59:32.969279 refract-serving-0.0.8/refract_serving/batch_serving/__pycache__/
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     2383 2024-04-25 05:48:53.000000 refract-serving-0.0.8/refract_serving/batch_serving/__pycache__/constants.cpython-38.pyc
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     1218 2024-04-25 05:48:53.000000 refract-serving-0.0.8/refract_serving/batch_serving/__pycache__/utils.cpython-38.pyc
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)    10322 2024-04-25 05:57:26.000000 refract-serving-0.0.8/refract_serving/batch_serving/app.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     1877 2024-04-24 03:31:22.000000 refract-serving-0.0.8/refract_serving/batch_serving/constants.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)      243 2024-04-25 05:23:07.000000 refract-serving-0.0.8/refract_serving/batch_serving/init_script.sh
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     1650 2024-04-24 03:31:22.000000 refract-serving-0.0.8/refract_serving/batch_serving/utils.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)      363 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/config.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     3786 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/constants.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     2698 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/decorators.py
-drwxr-xr-x   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:59:32.969279 refract-serving-0.0.8/refract_serving/explainableai/
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)        0 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/explainableai/__init__.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)    15283 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/explainableai/local_interpretation.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     5096 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/loader.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     1052 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/middlewares.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     1007 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/models.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     1162 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/schema.py
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)     6120 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/swagger_template.json
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)    18397 2024-04-24 04:23:40.000000 refract-serving-0.0.8/refract_serving/utils.py
-drwxr-xr-x   0 10670132 (130145352) domain^users (130023937)        0 2024-04-25 05:59:32.969279 refract-serving-0.0.8/refract_serving.egg-info/
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)      264 2024-04-25 05:59:32.000000 refract-serving-0.0.8/refract_serving.egg-info/PKG-INFO
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)      900 2024-04-25 05:59:32.000000 refract-serving-0.0.8/refract_serving.egg-info/SOURCES.txt
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)        1 2024-04-25 05:59:32.000000 refract-serving-0.0.8/refract_serving.egg-info/dependency_links.txt
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)       16 2024-04-25 05:59:32.000000 refract-serving-0.0.8/refract_serving.egg-info/top_level.txt
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)       38 2024-04-25 05:59:32.969279 refract-serving-0.0.8/setup.cfg
--rw-r--r--   0 10670132 (130145352) domain^users (130023937)      480 2024-04-25 05:57:32.000000 refract-serving-0.0.8/setup.py
...
### Comparing `refract-serving-0.0.8/refract_serving/app.py` & `refract-serving-1.0.1a0/refract_serving/app.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/batch_serving/app.py` & `refract-serving-1.0.1a0/refract_serving/batch_serving/app.py`
...
### Comparing `refract-serving-0.0.8/refract_serving/batch_serving/constants.py` & `refract-serving-1.0.1a0/refract_serving/batch_serving/constants.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/batch_serving/utils.py` & `refract-serving-1.0.1a0/refract_serving/batch_serving/utils.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/constants.py` & `refract-serving-1.0.1a0/refract_serving/constants.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/decorators.py` & `refract-serving-1.0.1a0/refract_serving/decorators.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/explainableai/local_interpretation.py` & `refract-serving-1.0.1a0/refract_serving/explainableai/local_interpretation.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/loader.py` & `refract-serving-1.0.1a0/refract_serving/loader.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/middlewares.py` & `refract-serving-1.0.1a0/refract_serving/middlewares.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/models.py` & `refract-serving-1.0.1a0/refract_serving/models.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/schema.py` & `refract-serving-1.0.1a0/refract_serving/schema.py`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/swagger_template.json` & `refract-serving-1.0.1a0/refract_serving/swagger_template.json`

 * *Files identical despite different names*

### Comparing `refract-serving-0.0.8/refract_serving/utils.py` & `refract-serving-1.0.1a0/refract_serving/utils.py`
