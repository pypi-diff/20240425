# Comparing `tmp/zonevu-1.1.21-py3-none-any.whl.zip` & `tmp/zonevu-1.1.22-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,8 +1,8 @@
-Zip file size: 176540 bytes, number of entries: 129
+Zip file size: 176718 bytes, number of entries: 129
...
--rw-r--r--  2.0 fat     8039 b- defN 80-Jan-01 00:00 zonevu/DataModels/Geosteering/Calcs.py
+-rw-r--r--  2.0 fat     8290 b- defN 80-Jan-01 00:00 zonevu/DataModels/Geosteering/Calcs.py
 ...
 -rw-r--r--  2.0 fat     2840 b- defN 80-Jan-01 00:00 zonevu/DataModels/Geosteering/Interpretation.py
 -rw-r--r--  2.0 fat     2190 b- defN 80-Jan-01 00:00 zonevu/DataModels/Geosteering/Pick.py
...
@@ -77,15 +77,15 @@
 ...
 -rw-r--r--  2.0 fat     5748 b- defN 80-Jan-01 00:00 zonevu/Examples/Plot/CrossSection2.py
...
--rw-r--r--  2.0 fat     3052 b- defN 80-Jan-01 00:00 zonevu/Examples/Retrieval/FlatGeosteerPicks.py
+-rw-r--r--  2.0 fat     3404 b- defN 80-Jan-01 00:00 zonevu/Examples/Retrieval/FlatGeosteerPicks.py
 ...
 -rw-r--r--  2.0 fat     1809 b- defN 80-Jan-01 00:00 zonevu/Examples/Retrieval/ListWells.py
@@ -121,11 +121,11 @@
 ...
 -rw-r--r--  2.0 fat     4844 b- defN 80-Jan-01 00:00 zonevu/Services/WelllogService.py
 -rw-r--r--  2.0 fat    11863 b- defN 80-Jan-01 00:00 zonevu/Services/WellService.py
 -rw-r--r--  2.0 fat     2947 b- defN 80-Jan-01 00:00 zonevu/Services/WelltopService.py
 -rw-r--r--  2.0 fat     7228 b- defN 80-Jan-01 00:00 zonevu/Zonevu.py
--rw-r--r--  2.0 fat     1103 b- defN 80-Jan-01 00:00 zonevu-1.1.21.dist-info/METADATA
--rw-r--r--  2.0 fat       88 b- defN 80-Jan-01 00:00 zonevu-1.1.21.dist-info/WHEEL
-?rw-r--r--  2.0 fat    11975 b- defN 16-Jan-01 00:00 zonevu-1.1.21.dist-info/RECORD
-129 files, 394812 bytes uncompressed, 157326 bytes compressed:  60.2%
+-rw-r--r--  2.0 fat     1103 b- defN 80-Jan-01 00:00 zonevu-1.1.22.dist-info/METADATA
+-rw-r--r--  2.0 fat       88 b- defN 80-Jan-01 00:00 zonevu-1.1.22.dist-info/WHEEL
+?rw-r--r--  2.0 fat    11975 b- defN 16-Jan-01 00:00 zonevu-1.1.22.dist-info/RECORD
+129 files, 395415 bytes uncompressed, 157504 bytes compressed:  60.2%
```
...
-Filename: zonevu-1.1.21.dist-info/METADATA
+Filename: zonevu-1.1.22.dist-info/METADATA
 Comment: 
 
-Filename: zonevu-1.1.21.dist-info/WHEEL
+Filename: zonevu-1.1.22.dist-info/WHEEL
 Comment: 
 
-Filename: zonevu-1.1.21.dist-info/RECORD
+Filename: zonevu-1.1.22.dist-info/RECORD
 Comment: 
...
@@ -154,15 +154,21 @@
 ...
 def create_extended_picks(interp: Interpretation, strat_col: StratColumn, well_elev: float) -> List[PickEx]:
...
+    :param well_elev: The datum elevation of the well (KB)
+    :return:
+    """
...
## zonevu/Examples/Retrieval/FlatGeosteerPicks.py
...
+                is_target = interp.target_formation_id == h.formation.id
+                target_symbol = '*' if is_target else ''
...
## Comparing `zonevu-1.1.21.dist-info/METADATA` & `zonevu-1.1.22.dist-info/METADATA`
...
## Comparing `zonevu-1.1.21.dist-info/RECORD` & `zonevu-1.1.22.dist-info/RECORD`
...
-zonevu/DataModels/Geosteering/Calcs.py,sha256=d7l6zi_5A-WldZQWWE1ITAlit6pr0nanWrYOqajGOoY,8039
+zonevu/DataModels/Geosteering/Calcs.py,sha256=yUy945umltNiKaZih1kmXO6JthVGLAuPBq76ZjQPEw0,8290
 ...
 zonevu/DataModels/Geosteering/Interpretation.py,sha256=QQFplkG_2ARLJYYt-kuIpSgUiPGlzFdWO5pLDdEuKxk,2840
 zonevu/DataModels/Geosteering/Pick.py,sha256=dkCIX30vTwQLnjeGiDBydJN1flyQn_mzYuzgMVBqv_A,2190
...
@@ -76,15 +76,15 @@
 ...
 zonevu/Examples/Plot/CrossSection2.py,sha256=1sroj76CuLbyDyvAQ2xS_KtMlC2D4jkdgoeyy3Q2tiI,5748
...
-zonevu/Examples/Retrieval/FlatGeosteerPicks.py,sha256=nTplWS6piOP_aCZvnIoqSRyFZp0WpNRAGmoUb3RgP-Q,3052
+zonevu/Examples/Retrieval/FlatGeosteerPicks.py,sha256=LLIziDUrHVRI-uopg90OtwFrxlL-MI10Bbn2Dwp2s54,3404
 ...
 zonevu/Examples/Retrieval/ListWells.py,sha256=pxuYX78UcdVwLqcncAiv0SBycq9WjUIcMpwg033ZkyU,1809
@@ -120,10 +120,10 @@
 ...
 zonevu/Services/WelllogService.py,sha256=oD4PJSnXNl67AsEMAbSxP5X7pjRw4ndC2Xk7ojLg-Dk,4844
 zonevu/Services/WellService.py,sha256=mHdwHooVL42dstXERvl3UYcuG0ZYoxxHnewxh2rUUKQ,11863
 zonevu/Services/WelltopService.py,sha256=TeSLhL_9Ux6QcgUayzm9_C4bL0DqgVkSZgZmTIgIDkk,2947
 zonevu/Zonevu.py,sha256=gDFGJDX0TU4lIkTaxbJPsiumFGJV1MdqG8iWVgCshBU,7228
-zonevu-1.1.21.dist-info/METADATA,sha256=uKJA5A0nu3f_k5JXz7Fv8_lh9pUQghOgTcLKfjV47BY,1103
-zonevu-1.1.21.dist-info/WHEEL,sha256=FMvqSimYX_P7y0a7UY-_Mc83r5zkBZsCYPm7Lr0Bsq4,88
-zonevu-1.1.21.dist-info/RECORD,,
+zonevu-1.1.22.dist-info/METADATA,sha256=SXKTZ49HJ2GkoEkVWkySLrQmWnCezV8LcJjASCydhRc,1103
+zonevu-1.1.22.dist-info/WHEEL,sha256=FMvqSimYX_P7y0a7UY-_Mc83r5zkBZsCYPm7Lr0Bsq4,88
+zonevu-1.1.22.dist-info/RECORD,,
```
