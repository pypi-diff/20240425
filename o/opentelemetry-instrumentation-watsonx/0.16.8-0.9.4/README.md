# Comparing `tmp/opentelemetry_instrumentation_watsonx-0.16.8.tar.gz` & `tmp/opentelemetry_instrumentation_watsonx-0.9.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "opentelemetry_instrumentation_watsonx-0.16.8.tar", max compression
+gzip compressed data, was "opentelemetry_instrumentation_watsonx-0.9.4.tar", max compression
```

## Comparing `opentelemetry_instrumentation_watsonx-0.16.8.tar` & `opentelemetry_instrumentation_watsonx-0.9.4.tar`

### file list

```diff
@@ -1,7 +1,5 @@
--rw-r--r--   0        0        0     1495 2024-04-25 17:16:01.261322 opentelemetry_instrumentation_watsonx-0.16.8/README.md
--rw-r--r--   0        0        0    17891 2024-04-25 17:16:01.261322 opentelemetry_instrumentation_watsonx-0.16.8/opentelemetry/instrumentation/watsonx/__init__.py
--rw-r--r--   0        0        0       42 2024-04-25 17:16:01.261322 opentelemetry_instrumentation_watsonx-0.16.8/opentelemetry/instrumentation/watsonx/config.py
--rw-r--r--   0        0        0      701 2024-04-25 17:16:01.261322 opentelemetry_instrumentation_watsonx-0.16.8/opentelemetry/instrumentation/watsonx/utils.py
--rw-r--r--   0        0        0       23 2024-04-25 17:16:01.261322 opentelemetry_instrumentation_watsonx-0.16.8/opentelemetry/instrumentation/watsonx/version.py
--rw-r--r--   0        0        0     1008 2024-04-25 17:16:25.705721 opentelemetry_instrumentation_watsonx-0.16.8/pyproject.toml
--rw-r--r--   0        0        0     2553 1970-01-01 00:00:00.000000 opentelemetry_instrumentation_watsonx-0.16.8/PKG-INFO
...
### Comparing `opentelemetry_instrumentation_watsonx-0.16.8/README.md` & `opentelemetry_instrumentation_watsonx-0.9.4/README.md`
