# Comparing `tmp/codeanim-0.0.15.tar.gz` & `tmp/codeanim-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "codeanim-0.0.15.tar", max compression
+gzip compressed data, was "codeanim-0.0.9.tar", max compression
```

## Comparing `codeanim-0.0.15.tar` & `codeanim-0.0.9.tar`

### file list

```diff
@@ -1,14 +1,12 @@
--rw-r--r--   0        0        0     1068 2024-04-24 23:10:39.202885 codeanim-0.0.15/LICENSE
--rw-r--r--   0        0        0     2263 2024-04-24 23:10:39.202885 codeanim-0.0.15/README.md
--rw-r--r--   0        0        0      408 2024-04-24 23:10:39.202885 codeanim-0.0.15/pyproject.toml
--rwxr-xr-x   0        0        0     2097 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/__init__.py
--rw-r--r--   0        0        0     1719 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/chrome.py
--rw-r--r--   0        0        0     2264 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/core.py
--rw-r--r--   0        0        0     1152 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/delayer.py
--rw-r--r--   0        0        0      824 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/interpolators.py
--rw-r--r--   0        0        0     1770 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/keyboard.py
--rw-r--r--   0        0        0     1338 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/markdown.py
--rw-r--r--   0        0        0     1200 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/mouse.py
--rw-r--r--   0        0        0     1058 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/shell.py
--rw-r--r--   0        0        0     3018 2024-04-24 23:10:39.202885 codeanim-0.0.15/src/codeanim/vscode.py
--rw-r--r--   0        0        0     2683 1970-01-01 00:00:00.000000 codeanim-0.0.15/PKG-INFO
...
### Comparing `codeanim-0.0.15/LICENSE` & `codeanim-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.15/src/codeanim/__init__.py` & `codeanim-0.0.9/src/codeanim/__init__.py`
...
### Comparing `codeanim-0.0.15/src/codeanim/chrome.py` & `codeanim-0.0.9/src/codeanim/chrome.py`
...
### Comparing `codeanim-0.0.15/src/codeanim/core.py` & `codeanim-0.0.9/src/codeanim/keyboard.py`
...
### Comparing `codeanim-0.0.15/src/codeanim/delayer.py` & `codeanim-0.0.9/src/codeanim/delayer.py`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.15/src/codeanim/keyboard.py` & `codeanim-0.0.9/src/codeanim/core.py`
...
### Comparing `codeanim-0.0.15/src/codeanim/markdown.py` & `codeanim-0.0.9/src/codeanim/markdown.py`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.15/src/codeanim/shell.py` & `codeanim-0.0.9/src/codeanim/shell.py`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.15/src/codeanim/vscode.py` & `codeanim-0.0.9/src/codeanim/vscode.py`
...
### Comparing `codeanim-0.0.15/PKG-INFO` & `codeanim-0.0.9/PKG-INFO`
