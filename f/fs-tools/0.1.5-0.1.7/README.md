# Comparing `tmp/fs_tools-0.1.5.tar.gz` & `tmp/fs_tools-0.1.7.tar.gz`
...
## Comparing `fs_tools-0.1.5.tar` & `fs_tools-0.1.7.tar`
...
### Comparing `fs_tools-0.1.5/pyproject.toml` & `fs_tools-0.1.7/pyproject.toml`
...
### Comparing `fs_tools-0.1.5/src/fs/compression.py` & `fs_tools-0.1.7/src/fs/compression.py`

 * *Files identical despite different names*

### Comparing `fs_tools-0.1.5/src/fs/io.py` & `fs_tools-0.1.7/src/fs/io.py`

 * *Files identical despite different names*

### Comparing `fs_tools-0.1.5/src/fs/moving.py` & `fs_tools-0.1.7/src/fs/moving.py`

 * *Files identical despite different names*

### Comparing `fs_tools-0.1.5/src/fs/paths.py` & `fs_tools-0.1.7/src/fs/paths.py`
