# Comparing `tmp/gingerai-0.1.5.tar.gz` & `tmp/gingerai-0.1.6.tar.gz`
...
## Comparing `gingerai-0.1.5.tar` & `gingerai-0.1.6.tar`
...
### Comparing `gingerai-0.1.5/gingerai/TorchNetWrapper.py` & `gingerai-0.1.6/gingerai/TorchNetWrapper.py`
