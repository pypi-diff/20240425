# Comparing `tmp/sbcli_dev-2.3.6.zip` & `tmp/sbcli_dev-2.3.7.zip`
...
## Comparing `sbcli_dev-2.3.6/simplyblock_core/storage_node_ops.py` & `sbcli_dev-2.3.7/simplyblock_core/storage_node_ops.py`
...
## Comparing `sbcli_dev-2.3.6/simplyblock_core/services/lvol_monitor.py` & `sbcli_dev-2.3.7/simplyblock_core/services/lvol_monitor.py`
...
## Comparing `sbcli_dev-2.3.6/simplyblock_core/scripts/stack_deploy_wait.sh` & `sbcli_dev-2.3.7/simplyblock_core/scripts/stack_deploy_wait.sh`
...
## Comparing `sbcli_dev-2.3.6/simplyblock_core/controllers/device_events.py` & `sbcli_dev-2.3.7/simplyblock_core/controllers/device_events.py`
...
## Comparing `sbcli_dev-2.3.6/simplyblock_web/app.py` & `sbcli_dev-2.3.7/simplyblock_web/app.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/auth_middleware.py` & `sbcli_dev-2.3.7/simplyblock_web/auth_middleware.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/caching_node_app.py` & `sbcli_dev-2.3.7/simplyblock_web/caching_node_app.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/utils.py` & `sbcli_dev-2.3.7/simplyblock_web/utils.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/node_webapp.py` & `sbcli_dev-2.3.7/simplyblock_web/node_webapp.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/static/delete.py` & `sbcli_dev-2.3.7/simplyblock_web/static/delete.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/static/deploy.py` & `sbcli_dev-2.3.7/simplyblock_web/static/deploy.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/static/deploy_spdk.yaml` & `sbcli_dev-2.3.7/simplyblock_web/static/deploy_spdk.yaml`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/templates/deploy_spdk.yaml.j2` & `sbcli_dev-2.3.7/simplyblock_web/templates/deploy_spdk.yaml.j2`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/node_api_caching_docker.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/node_api_caching_docker.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/node_api_caching_ks.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/node_api_caching_ks.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_caching_node.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_caching_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/snode_ops.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/snode_ops.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_lvol.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_lvol.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/csi.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/csi.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/caching_node_ops.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/caching_node_ops.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_mgmt_node.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_mgmt_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_storage_node.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_storage_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/caching_node_ops_k8s.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/caching_node_ops_k8s.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_device.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_device.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_cluster.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_cluster.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/node_api_basic.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/node_api_basic.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.3.6/simplyblock_web/blueprints/web_api_pool.py` & `sbcli_dev-2.3.7/simplyblock_web/blueprints/web_api_pool.py`
